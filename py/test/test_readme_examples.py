# BrewpageHosting SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions BrewpageHostingSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both BrewpageHostingSDK(...) and BrewpageHostingSDK.test(...) become
#      BrewpageHostingSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "brewpagehosting_sdk"
_SDK_CLASS = "BrewpageHostingSDK"
