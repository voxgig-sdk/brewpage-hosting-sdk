...
from brewpagehosting_sdk.utility import register

# Load features
from brewpagehosting_sdk.feature.base_feature import BrewpageHostingBaseFeature
from brewpagehosting_sdk.features import _has_feature, _make_feature
...
class BrewpageHostingSDK:
    ...
    def get_utility(self):
        return BrewpageHostingUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("BrewpageHostingSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Stat(self, data=None) -> "StatEntity":
        ...
        from brewpagehosting_sdk.entity.stat_entity import StatEntity
        return StatEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "BrewpageHostingSDK":
        if sdkopts is None:
            sdkopts = {}
