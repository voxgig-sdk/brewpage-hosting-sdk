# BrewpageHosting TypeScript SDK Reference

Complete API reference for the BrewpageHosting TypeScript SDK.
...
```ts
new BrewpageHostingSDK(options?: object)
```
...
#### `BrewpageHostingSDK.test(testopts?, sdkopts?)`
...
**Returns:** `BrewpageHostingSDK` instance in test mode.
...
Alias for `BrewpageHostingSDK.test()`.
...
Return the parent `BrewpageHostingSDK` instance.
