...
#      offline in seeded test mode (BrewpageHostingSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "BrewpageHosting_sdk.rb")
  SDK_CLASS = "BrewpageHostingSDK"
