...
func registerSDKWords(r *eng.Registry, client *sdk.BrewpageHostingSDK) {
...
func runOp(client *sdk.BrewpageHostingSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
