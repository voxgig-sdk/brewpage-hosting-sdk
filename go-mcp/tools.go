...
type Args struct {
	Entity string         `json:"entity" jsonschema:"stat"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.BrewpageHostingSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "brewpage-hosting_list",
		Description: "List records from BrewpageHosting. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "brewpage-hosting_load",
		Description: "Load a single record from BrewpageHosting. " +
...
func runOp(client *sdk.BrewpageHostingSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.BrewpageHostingSDK, name string) (sdk.BrewpageHostingEntity, error) {
