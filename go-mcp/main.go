// Command BrewpageHosting-mcp is an MCP server exposing the BrewpageHosting
// SDK as MCP tools.
//
// Two tools are registered:
//
//	BrewpageHosting_list  — list records of an entity
//	BrewpageHosting_load  — load a single record of an entity
//
