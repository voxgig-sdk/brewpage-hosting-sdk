...
from projectname_sdk.core.control import BrewpageHostingControl
...
class BrewpageHostingContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = BrewpageHostingControl()
        ...
        if isinstance(sp, BrewpageHostingSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, BrewpageHostingResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, BrewpageHostingResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return BrewpageHostingOperation({})
    ...
    def make_error(self, code, msg):
        return BrewpageHostingError(code, msg, self)
