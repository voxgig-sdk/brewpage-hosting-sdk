...
// BrewpageHosting SDK netsim feature
...
class BrewpageHostingNetsimFeature extends BrewpageHostingBaseFeature
{
    ...
    private function _simulate(BrewpageHostingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(BrewpageHostingContext $ctx, array $applied): void
    {
        $client = $this->client;
