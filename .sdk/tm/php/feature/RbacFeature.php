...
// BrewpageHosting SDK rbac feature
...
class BrewpageHostingRbacFeature extends BrewpageHostingBaseFeature
{
    ...
    private function _required(BrewpageHostingContext $ctx): ?string
    {
    ...
    private function _reject(BrewpageHostingContext $ctx, string $required): void
    {
    ...
    private function _track(BrewpageHostingContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
