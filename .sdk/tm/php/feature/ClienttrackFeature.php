...
// BrewpageHosting SDK clienttrack feature
...
class BrewpageHostingClienttrackFeature extends BrewpageHostingBaseFeature
{
    ...
    public function PostConstruct(BrewpageHostingContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'BrewpageHosting-SDK';
