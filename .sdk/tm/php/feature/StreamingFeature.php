...
// BrewpageHosting SDK streaming feature
...
class BrewpageHostingStreamingFeature extends BrewpageHostingBaseFeature
{
    ...
    private function _iterate(BrewpageHostingResult $result): \Generator
    {
    ...
    private function _streamable(BrewpageHostingContext $ctx): bool
    {
