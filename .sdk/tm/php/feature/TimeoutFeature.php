...
// BrewpageHosting SDK timeout feature
...
class BrewpageHostingTimeoutFeature extends BrewpageHostingBaseFeature
{
    ...
    private function _with_timeout(BrewpageHostingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(BrewpageHostingContext $_ctx, float $ms): void
    {
        $client = $this->client;
