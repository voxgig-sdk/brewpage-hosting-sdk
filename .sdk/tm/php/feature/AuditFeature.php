...
// BrewpageHosting SDK audit feature
...
class BrewpageHostingAuditFeature extends BrewpageHostingBaseFeature
{
    ...
    private function _emit(BrewpageHostingContext $ctx, string $outcome): void
    {
