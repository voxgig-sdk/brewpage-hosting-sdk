...
// BrewpageHosting SDK utility type

class BrewpageHostingUtility
{
    ...
    public static function copy(BrewpageHostingUtility $src): BrewpageHostingUtility
    {
        $u = new BrewpageHostingUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
