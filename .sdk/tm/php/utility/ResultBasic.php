...
// BrewpageHosting SDK utility: result_basic

class BrewpageHostingResultBasic
{
    public static function call(BrewpageHostingContext $ctx): ?BrewpageHostingResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof BrewpageHostingError) ? $result->err->msg : (string)$result->err;
