...
// BrewpageHosting SDK utility: graphql
//
...
class BrewpageHostingGraphql
{
    ...
    // equivalent.
    public static function body(BrewpageHostingContext $ctx): mixed
    {
    ...
    public static function errors(BrewpageHostingContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
