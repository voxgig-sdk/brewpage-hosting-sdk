...
// BrewpageHosting SDK utility: fetcher

class BrewpageHostingFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; BrewpageHostingSDK/1.0)';
    ...
    public static function call(BrewpageHostingContext $ctx, string $fullurl, array $fetchdef): array
    {
