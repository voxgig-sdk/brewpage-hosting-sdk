...
|---|---|---|
| `ts/` | @voxgig-sdk/brewpage-hosting-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/brewpage-hosting-sdk \
      --repository voxgig-sdk/brewpage-hosting-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/brewpage-hosting-sdk` shows it, and
`npm trust revoke @voxgig-sdk/brewpage-hosting-sdk --id=<id>` removes it.
