...
describe("StatEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set BREWPAGE_HOSTING_TEST_STAT_ENTID JSON to run live")
      return
    end
...
function stat_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("BREWPAGE_HOSTING_TEST_STAT_ENTID")
  ...
  if env["BREWPAGE_HOSTING_TEST_LIVE"] == "TRUE" then
  ...
  local live = env["BREWPAGE_HOSTING_TEST_LIVE"] == "TRUE"
  return {
    client = client,
    data = entity_data,
