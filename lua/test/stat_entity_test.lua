...
describe("StatEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set BREWPAGEHOSTING_TEST_STAT_ENTID JSON to run live")
      return
    end
...
function stat_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("BREWPAGEHOSTING_TEST_STAT_ENTID")
  ...
  if env["BREWPAGEHOSTING_TEST_LIVE"] == "TRUE" then
  ...
  local live = env["BREWPAGEHOSTING_TEST_LIVE"] == "TRUE"
  return {
    client = client,
    data = entity_data,
