...
// BrewpageHosting SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (BrewpageHostingSDK::test)
...
{
    private const SDK_CLASS = 'BrewpageHostingSDK';
    ...
    private const SDK_BASE = 'brewpagehosting_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../brewpagehosting_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
