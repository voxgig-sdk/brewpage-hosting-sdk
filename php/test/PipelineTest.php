...
// BrewpageHosting SDK pipeline test
//
...
require_once __DIR__ . '/../brewpagehosting_sdk.php';
...
{
    private static function utility(): BrewpageHostingUtility
    {
        return new BrewpageHostingUtility();
    }
    ...
    private static function ctx(array $over = []): BrewpageHostingContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new BrewpageHostingContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new BrewpageHostingOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof BrewpageHostingError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new BrewpageHostingOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = BrewpageHostingMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new BrewpageHostingOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = BrewpageHostingMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new BrewpageHostingOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = BrewpageHostingMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BrewpageHostingSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = BrewpageHostingMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new BrewpageHostingResponse([]),
            'result' => new BrewpageHostingResult([]),
        ]);
        [, $err] = BrewpageHostingMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new BrewpageHostingSpec([]),
            'response' => null,
            'result' => new BrewpageHostingResult([]),
        ]);
        [, $err] = BrewpageHostingMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new BrewpageHostingSpec(['step' => 's']),
            'response' => new BrewpageHostingResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new BrewpageHostingResult([]),
        ]);
        [, $err] = BrewpageHostingMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new BrewpageHostingSpec(['step' => 's']),
            'response' => new BrewpageHostingResponse(self::resp(200, ['v' => 1])),
            'result' => new BrewpageHostingResult([]),
        ]);
        [, $err] = BrewpageHostingMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new BrewpageHostingSpec(['step' => 's']),
            'response' => new BrewpageHostingResponse(self::resp(200, ['v' => 2])),
            'result' => new BrewpageHostingResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        BrewpageHostingMakeResponse::call($ctx);
    ...
    {
        $preset = new BrewpageHostingResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new BrewpageHostingSpec([]),
            'response' => new BrewpageHostingResponse([]),
            'result' => new BrewpageHostingResult([]),
        ...
        [$got, $err] = BrewpageHostingMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new BrewpageHostingResult([])]);
        [, $err] = BrewpageHostingMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new BrewpageHostingSpec([]), 'result' => null]);
        [, $err] = BrewpageHostingMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BrewpageHostingSpec(['step' => 's']),
            'result' => new BrewpageHostingResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new BrewpageHostingOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BrewpageHostingMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BrewpageHostingSpec(['step' => 's']),
            'result' => new BrewpageHostingResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new BrewpageHostingOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BrewpageHostingMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BrewpageHostingResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new BrewpageHostingSpec([]),
            'result' => new BrewpageHostingResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = BrewpageHostingMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BrewpageHostingMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new BrewpageHostingError('boom', 'boom');
        $utility->fetcher = function (BrewpageHostingContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BrewpageHostingSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = BrewpageHostingMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (BrewpageHostingContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = BrewpageHostingMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(BrewpageHostingResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        BrewpageHostingMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (BrewpageHostingContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BrewpageHostingSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = BrewpageHostingMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new BrewpageHostingResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new BrewpageHostingSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = BrewpageHostingMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = BrewpageHostingMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = BrewpageHostingMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new BrewpageHostingResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, BrewpageHostingDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new BrewpageHostingResult(['ok' => false])]);
        $this->expectException(BrewpageHostingError::class);
        BrewpageHostingDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new BrewpageHostingResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', BrewpageHostingMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        BrewpageHostingMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new BrewpageHostingBaseFeature();
        $b = new BrewpageHostingBaseFeature();
        BrewpageHostingFeatureAdd::call($ctx, $a);
        BrewpageHostingFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): BrewpageHostingBaseFeature
    {
        $f = new BrewpageHostingBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        BrewpageHostingFeatureAdd::call($ctx, self::named_feature('a'));
        BrewpageHostingFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        BrewpageHostingFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        BrewpageHostingFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        BrewpageHostingFeatureAdd::call($ctx, $replace);
        ...
        BrewpageHostingFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): BrewpageHostingContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new BrewpageHostingSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BrewpageHostingPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        BrewpageHostingPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new BrewpageHostingResponse(['headers' => null]),
            'result' => new BrewpageHostingResult([]),
        ]);
        BrewpageHostingResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        BrewpageHostingResultBody::call($ctx);
