...
// BrewpageHosting SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class BrewpageHostingMakeRequest
{
    public static function call(BrewpageHostingContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new BrewpageHostingResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new BrewpageHostingResponse($fetched);
        } else {
