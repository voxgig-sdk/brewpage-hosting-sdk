...
// BrewpageHosting SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class BrewpageHostingTransformResponse
{
    public static function call(BrewpageHostingContext $ctx): mixed
    {
        ...
        $transform = BrewpageHostingHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
