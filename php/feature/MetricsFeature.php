...
// BrewpageHosting SDK metrics feature
...
class BrewpageHostingMetricsFeature extends BrewpageHostingBaseFeature
{
    ...
    private function _record(BrewpageHostingContext $ctx, bool $ok): void
    {
