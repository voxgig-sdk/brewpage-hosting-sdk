...
// BrewpageHosting SDK debug feature
...
class BrewpageHostingDebugFeature extends BrewpageHostingBaseFeature
{
    ...
    private function _finish(BrewpageHostingContext $ctx, bool $ok): void
    {
