...
// BrewpageHosting SDK proxy feature
...
class BrewpageHostingProxyFeature extends BrewpageHostingBaseFeature
{
    ...
    public function init(BrewpageHostingContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (BrewpageHostingContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
