...
// BrewpageHosting SDK telemetry feature
...
class BrewpageHostingTelemetryFeature extends BrewpageHostingBaseFeature
{
    ...
    private function _close(BrewpageHostingContext $ctx, bool $ok): void
    {
