...
// BrewpageHosting SDK ratelimit feature
...
class BrewpageHostingRatelimitFeature extends BrewpageHostingBaseFeature
{
    ...
    private function _acquire(BrewpageHostingContext $ctx): void
    {
    ...
    private function _track(BrewpageHostingContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
