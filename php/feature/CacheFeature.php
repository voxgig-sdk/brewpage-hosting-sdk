...
// BrewpageHosting SDK cache feature
...
class BrewpageHostingCacheFeature extends BrewpageHostingBaseFeature
{
    ...
    private function _through(BrewpageHostingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
