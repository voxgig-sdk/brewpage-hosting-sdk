...
// BrewpageHosting SDK idempotency feature
...
class BrewpageHostingIdempotencyFeature extends BrewpageHostingBaseFeature
{
    ...
    private function _mutating(BrewpageHostingContext $ctx): bool
    {
